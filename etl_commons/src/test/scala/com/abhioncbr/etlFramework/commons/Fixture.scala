...
object Fixture {
  ...
  val catalogueFormatArgs2: Option[Array[GeneralParamConf]] = Some(Array(catalogueInfixPatternFormatArg1, catalogueInfixPatternFormatArg2))
  ...
  val feedPattern2: PathInfixParam = PathInfixParam(infixPattern = feedInfixPattern1, formatInfix = Some(true), formatInfixArgs =feedFormatArgs1)
  val feedPattern3: PathInfixParam = PathInfixParam(infixPattern = feedInfixPattern2, formatInfix = Some(true), formatInfixArgs =feedFormatArgs2)
  ...
  val dataPath2: DataPath = DataPath(pathPrefix = Some(pathPrefix), cataloguePatterns = cataloguePatterns1, feedPattern = Some(feedPattern1), None)
  val dataPath3: DataPath = DataPath(pathPrefix = Some(pathPrefix), cataloguePatterns = cataloguePatterns1, feedPattern = Some(feedPattern1), fileName = Some(fileNameParam1))
}
