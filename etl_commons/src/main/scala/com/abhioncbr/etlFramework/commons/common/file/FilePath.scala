...
case class PathInfixParam(order: Option[Int] = Some(-1), infixPattern: String, formatInfix: Option[Boolean] = Some(false), formatInfixArgs: Option[Array[GeneralParam]] =None)
