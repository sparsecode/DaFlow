...
import com.abhioncbr.etlFramework.etl.feed._
import com.abhioncbr.etlFramework.etl.feed.common.{Context, Extract, JobStaticParam, ProcessFrequencyEnum}
...
class FileNamePattern {
  ...
  private def getProcessFrequencyPattern(firstDate: DateTime, secondDate: Option[DateTime]): String = {
    ...
    import com.abhioncbr.etlFramework.etl.feed.common.ProcessFrequencyEnum._
