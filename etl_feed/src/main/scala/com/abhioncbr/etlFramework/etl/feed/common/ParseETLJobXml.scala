...
import com.abhioncbr.etlFramework.etl.feed.transformData.TransformationStep
import com.abhioncbr.etlFramework.etl.feed.common.ContextConstantEnum.{HADOOP_CONF, VENTURE}
import com.abhioncbr.etlFramework.etl.feed.extractData.{ExtractionType, QueryParamTypeEnum}
import com.abhioncbr.etlFramework.etl.feed.loadData.hive.PartitionColumnTypeEnum
import com.abhioncbr.etlFramework.etl.feed.transformData._
...
case class QueryParam(order: Int, paramName: String, paramValue: QueryParamTypeEnum.valueType, paramDefaultValue: String)
