...
echo "updating daflow feed stat table for job=$JOB_NAME, job_subtask=$JOB_SUBTASK_NAME, venture=$VENTURE, date=$DATE"
QUERY="INSERT INTO TABLE daflow.daflow-feed-stat PARTITION (job_name = '$JOB_NAME') (job_subtask, status, frequency,
