...
class ParseGeneralParamsSpec extends YamlJobConfBase{
  "ParseGeneralParam-fromYAML" should "return GeneralParam object when content is passed as an argument" in {
    val content: String =
      """
        |order: 1
        |name: "{col1}"
        ...
        |""".stripMargin
    val generalParamObject: GeneralParamConf = parseConfig[GeneralParamConf](content, YamlJobConfig.decodeGeneralParamConf)
  ...
  /*
  "ParseGeneralParams-fromYAML" should "return array of GeneralParam objects of length 2" in {
    val content: String = """<formatArgValues>
    ...
    val generalParamObjectArray: Array[GeneralParamConf] = parseConfig(content, YamlJobConfig.decodeGeneralParamConf)
  ...
  "ParseGeneralParams-fromYAML" should "return array of GeneralParam objects of length 0" in {
    val content: String = """<formatArgValues></formatArgValues>""".stripMargin
